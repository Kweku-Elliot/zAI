...
const languages = [
  ...
  { id: 'en-gh', name: 'English', flag: '🇬🇭', region: 'Ghana' },
  { id: 'tw', name: 'Twi', flag: '🇬🇭', region: 'Ghana' },
  { id: 'ak', name: 'Akan', flag: '🇬🇭', region: 'Ghana' },
  { id: 'ga', name: 'Ga', flag: '🇬🇭', region: 'Ghana' },
  { id: 'ee', name: 'Ewe', flag: '🇬🇭', region: 'Ghana' },
  { id: 'dag', name: 'Dagbani', flag: '🇬🇭', region: 'Ghana' },
  { id: 'ha', name: 'Hausa', flag: '🇬🇭', region: 'Ghana' },
  { id: 'gur', name: 'Farefare', flag: '🇬🇭', region: 'Ghana' },
